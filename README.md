...
The Python backend, runtime agent implementations, integrations, persistence, and isolated test executor are defined in the target architecture and are the next delivery phases.
...
See the complete component, repository-boundary, state-machine, sequence, security, and delivery documentation in [docs/architecture.md](docs/architecture.md).
